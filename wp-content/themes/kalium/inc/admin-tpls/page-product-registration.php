...
<div class="wrap about-wrap product-activation-wrap">
	...
	<div class="laborator-activate-theme-box">
        ...
        <?php
        // License is not activated, however its Envato Hosted site
		if ( kalium()->theme_license->isEnvatoHostedSite() ) :

            ?>
            <div class="theme-activation-button-container envato-hosted">
                <div class="theme-activation-description">
                    <h3>Theme Activation</h3>
                    <p>Since you are using Envato Hosted service, automatic activation is enabled with only one click.</p>
                </div>

                <div class="theme-activation-button">
                    <a href="<?php echo esc_url( admin_url( "admin.php?page=kalium-product-registration&purchase_code_request_verification=true" ) ); ?>" class="button button-primary theme-activate-button">Activate Product</a>
                </div>
            </div>
            <?php

        // Activate theme via Kalium API site
        else :
        ?>
		<div class="theme-activation-button-container">
			<div class="theme-activation-description">
